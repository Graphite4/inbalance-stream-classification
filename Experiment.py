...
if __name__ == '__main__':
    ...
    imbalance = [0.02, 0.05, 0.10, 0.20, 0.30]

    ensemble1 = AWE(clf, 10, "proportional_to_g-mean")
    ensemble2 = AWE(clf, 10, "proportional_to_bac")
    ensemble3 = AWE(clf, 10, "proportional_to_f1")
    ...
    ensemble7 = AWE(clf, 10, "proportional_to_g-mean", update=True)
    ensemble8 = AWE(clf, 10, "proportional_to_bac", update=True)
    ensemble9 = AWE(clf, 10, "proportional_to_f1", update=True)
